...
The purpose of this doc is to hold all the pseudocode for the [`card_games.py`](card_games.py) app. This file helps me to create a habit of thinking about the challenge before doing any coding.
